...
import TournamentStatisticsInfoDifferenceBage from "../TournamentStatisticsInfoDifferenceBage/TournamentStatisticsInfoDifferenceBage";
            ...
            <div className={style.statistics__info_wrap}>
                {statisticsInfo.map((info, index) => (
                    ...
                    >
                        ...
                        <div>
                            <TournamentStatisticsInfoDifferenceBage
